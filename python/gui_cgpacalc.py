...
g13.place(x=150,y=190,width=35)
g14 = Entry(f,bg='white',fg='black',borderwidth=1,relief='solid')
g14.place(x=185,y=190,width=35)
...
l20.place(x=150,y=265,width=35)
...
g25.place(x=150,y=350,width=35)
g26 = Entry(f,bg='white',fg='black',borderwidth=1,relief='solid')
g26.place(x=185,y=350,width=35)
